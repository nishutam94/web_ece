                ...
                <div id="wrapper">
                    <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
                        ...
                        <div style="color: white;
                             ...
                             float: right;
                             font-size: 16px;"> <a href="<?php echo $row['resume_link'];?>" class="btn btn-danger square-btn-adjust" style="background-color: turquoise;">RESUME</a> &nbsp;<a href="faculty.php" class="btn btn-danger square-btn-adjust" style="background-color: turquoise;">BACK</a></div> </div>
                    </nav>   
                    <!-- /. NAV TOP  -->
...
if ($result->num_rows > 0) {
    ...
    echo "<script>
 alert('FACULTY FULL INFORMATION NOT AVILABLE PLEASE UPDATE FACULTY PROFILE.');
