...
font-size: 16px;"> <?php 
                   ...
                   ?>
                     <a href="ProfileDisplay_2.php" class="btn btn-danger square-btn-adjust" style="background-color: turquoise;">VIEW PROFILE</a><?php }?> <a href="logout.php" class="btn btn-danger square-btn-adjust" style="background-color: turquoise;">LOGOUT</a> </div>
        </nav>   
           <!-- /. NAV TOP  -->
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <ul class="nav nav-pills">
                                <li class=""><a href="#home-pills" data-toggle="tab">PERSONAL DETAIL</a>
                                </li>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <ul class="nav nav-pills">
                                ...
                                <li class=""><a href="#profile-pills1" data-toggle="tab">NORMAL</a>
                                </li>
                            ...
                            <div class="tab-content">
                               ...
                               <div class="tab-pane fade" id="profile-pills22">
                                 ...
                                 <div class="tab-pane fade" id="profile-pills23">
                                     <?php  include 'adminstrative_experience_form.php';  ?>
                                </div>
                            </div>
                        </div>
                    </div>
...
<!--------------------------------------------------------->                     
  ...
  <div class="col-md-12 col-sm-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <ul class="nav nav-pills">
                                <li class=""><a href="#home-pills50" data-toggle="tab">ACADEMIC ACTIVITY EXPERIENCE</a>
                                </li>
                                <li class=""><a href="#profile-pills51" data-toggle="tab">GUEST LECTURES </a>
                                </li>
