          ...
          <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                        <a  data-toggle="collapse" data-parent="#accordion" href="#collapseOne" ><i class="" ></i> CONTACT</a>
                    </li>
       ...
       <div class="panel-group" id="accordion">
            <!---------------------------------------------------------->     
                                ...
                                <div class="panel panel-default">
                                 ...
                                 <?php  include 'address_info_form_1.php';  ?>    
                        ...
                        <div class="panel-body">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade" id="home-pills1">
                                     <?php  include 'Qualification_phd_form_1.php';  ?>                                 </div>
                                <div class="tab-pane fade" id="profile-pills1">
                                     <?php  include 'qualification_form_1.php';  ?>
                                </div>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade" id="home-pills20">
                                     <?php  include 'employment_record_form_1.php';  ?>                                 </div>
                                <div class="tab-pane fade" id="profile-pills21">
                                     <?php  include 'teaching_experience_form_1.php';  ?>
                                </div>
                               <div class="tab-pane fade" id="profile-pills22">
                                     <?php  include 'professional_membership_form_1.php';  ?>
                                </div>
                                 <div class="tab-pane fade" id="profile-pills23">
                                     <?php  include 'administrative_experience_form_1.php';  ?>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade" id="home-pills30">
                                     <?php  include 'project_supervised_form_1.php';  ?>                                 </div>
                                <div class="tab-pane fade" id="profile-pills31">
                                     <?php  include 'project_investigated_form_1.php';  ?>
                                </div>
                               <div class="tab-pane fade" id="profile-pills32">
                                     <?php  include 'project_form_1.php';  ?>
                                   
                                </div>
                                 <div class="tab-pane fade" id="profile-pills33">
                                     <?php  include 'adminstrative_experience_form_1.php';  ?>
                                </div>
                            </div>
                        </div>
                    </div>
...
<!-------------------------------------------------------->
    ...
    <?php   include 'conference_form_1.php';?>
   
  <!--------------------------------------------------------->       
       
     <?php       include 'publications_form_1.php';   ?>                          
                        ...
                        <div class="panel-body">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade" id="home-pills50">
                                     <?php  include 'books_form_1.php';  ?>                                 </div>
                                <div class="tab-pane fade" id="profile-pills51">
                                     <?php  include 'chapter_form_1.php';  ?>
                                </div>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade" id="home-pills60">
                                     <?php include 'academic_activity_form_1.php'; ?>                               </div>
                                <div class="tab-pane fade" id="profile-pills61">
                                     <?php  include 'delivered_guest_lecture_form_1.php';  ?>
                                </div>
...
<!--      <script src="assets/js/custom_1.js"></script>-->
     <script>
         $(function() 
         {   $( ".datepicker1" ).datepicker({dateFormat:'yy-mm-dd',yearRange:"1945:2020",changeMonth:true,changeYear:true}); 
            }
